    ...
    >
      <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-3 lg:grid-cols-12">
        ...
        >
          ...
          Transforming Surplus into Fairness          </h1>
          <h3 className="mt-4 text-xl font-semibold text-gray-600 dark:text-gray-300">
          Cultivating a Brighter Future
        </h3>
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-400">
          Connecting the Hospitality, Restaurant, and Catering (HoReCa) Sector with Non-Governmental Organizations (NGOs) 
          for Immediate Food Recovery and Community Sustenance. Join our initiative to convert 
          excess food into nourishing meals through NourishNet.
          </p>
